...
public abstract class AbstractHttpClient {
	 ...
	 */
	public abstract HttpResponse head(String path, ParameterMap params)
			throws HttpRequestException;
	/**
	 ...
	 * @throws HttpRequestException 
	 */
	public abstract HttpResponse post(String path, String contentType,
	 ...
	 * @throws HttpRequestException 
	 */
	public abstract HttpResponse put(String path, String contentType,
			byte[] data) throws HttpRequestException;
