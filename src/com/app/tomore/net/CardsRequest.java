...
public class CardsRequest {
	...
	public String updateCardInfo(String cardID, String cardTitle,
			String cardBarcode, String cardDes) throws IOException, TimeoutException {
		baseRequest = new BasicHttpClient(url);
		baseRequest.setConnectionTimeout(2000);
